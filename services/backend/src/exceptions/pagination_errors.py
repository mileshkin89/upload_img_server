...
class NotAvailablePerPageError(PaginationError):

    def __init__(self, value: Any, available_values: Any):
        self.value = value
        super().__init__(f"Not available per_page value: {value}. Per page must be in {available_values}.")